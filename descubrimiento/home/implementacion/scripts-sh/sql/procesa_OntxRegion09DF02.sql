create temporary table tmp_actualiza_ont_Region_09DF02 as
...
from tmp_actualiza_ont_Region_09DF02 x ) des 
join 
(select ip_olt, num_serie, ObjectId, OntId, Frame, Slot, Port 
from monitor_control_onts 
where tipo = 'E'
 and num_serie in (select serial from tmp_actualiza_ont_Region_09DF02) ) mon 
...
drop table tmp_actualiza_ont_Region_09DF02;